...
export const countersData: CounterInfo[] = [
  ...
  },
  {
    ...
    items: [
      { word: "りんご", reading: "りんご", emoji: "🍎", meaning: "táo" },
      { word: "みかん", reading: "みかん", emoji: "🍊", meaning: "quýt" },
      { word: "かぎ", reading: "かぎ", emoji: "🔑", meaning: "chìa khóa" },
      { word: "いす", reading: "いす", emoji: "🪑", meaning: "ghế" },
      { word: "かばん", reading: "かばん", emoji: "🎒", meaning: "cặp/túi xách" }
    ],
    conjugations: [
      { number: 1, kanji: "1つ", reading: "ひとつ", isSpecial: false },
      { number: 2, kanji: "2つ", reading: "ふたつ", isSpecial: false },
      { number: 3, kanji: "3つ", reading: "みっつ", isSpecial: false },
      { number: 4, kanji: "4つ", reading: "よっつ", isSpecial: false },
      { number: 5, kanji: "5つ", reading: "いつつ", isSpecial: false },
      { number: 6, kanji: "6つ", reading: "むっつ", isSpecial: false },
      { number: 7, kanji: "7つ", reading: "ななつ", isSpecial: false },
      { number: 8, kanji: "8つ", reading: "やっつ", isSpecial: false },
      { number: 9, kanji: "9つ", reading: "ここのつ", isSpecial: false },
      { number: 10, kanji: "10", reading: "とお", isSpecial: false },
    ],
  },
  {
    id: "ban",
    ...
    conjugations: [
      ...
      { number: 2, kanji: "2番", reading: "にばん", isSpecial: false },
      { number: 3, kanji: "3番", reading: "さんばん", isSpecial: false },
      { number: 4, kanji: "4番", reading: "よんばん", isSpecial: false },
      { number: 5, kanji: "5番", reading: "ごばん", isSpecial: false },
      { number: 6, kanji: "6番", reading: "ろくばん", isSpecial: false },
      { number: 7, kanji: "7番", reading: "ななばん", isSpecial: false },
      { number: 8, kanji: "8番", reading: "はちばん", isSpecial: false },
      { number: 9, kanji: "9番", reading: "きゅうばん", isSpecial: false },
      { number: 10, kanji: "10番", reading: "じゅうばん", isSpecial: false },
    ],
  },
  {
    id: "sai",
    ...
    conjugations: [
      { number: 1, kanji: "1歳", reading: "いっさい", isSpecial: true },
      { number: 2, kanji: "2歳", reading: "にさい", isSpecial: false },
      { number: 3, kanji: "3歳", reading: "さんさい", isSpecial: false },
      { number: 4, kanji: "4歳", reading: "よんさい", isSpecial: false },
      { number: 5, kanji: "5歳", reading: "ごさい", isSpecial: false },
      { number: 6, kanji: "6歳", reading: "ろくさい", isSpecial: false },
      { number: 7, kanji: "7歳", reading: "ななさい", isSpecial: false },
      { number: 8, kanji: "8歳", reading: "はっさい", isSpecial: true },
      { number: 9, kanji: "9歳", reading: "きゅうさい", isSpecial: false },
      { number: 10, kanji: "10歳", reading: "じゅっさい", isSpecial: true },
    ],
  },
  {
    id: "floor",
    ...
    items: [
      { word: "デパート", reading: "でぱーと", emoji: "🏬", meaning: "cửa hàng bách hóa" },
      { word: "病院", reading: "びょういん", emoji: "🏥", meaning: "bệnh viện" },
      { word: "マンション", reading: "まんしょん", emoji: "🏢", meaning: "chung cư" },
      { word: "エレベーター", reading: "えれべーたー", emoji: "🛗", meaning: "thang máy" },
      { word: "教室", reading: "きょうしつ", emoji: "🏫", meaning: "phòng học" }
    ],
    conjugations: [
      { number: 1, kanji: "1階", reading: "いっかい", isSpecial: true },
      { number: 2, kanji: "2階", reading: "にかい", isSpecial: false },
      { number: 3, kanji: "3階", reading: "さんがい", isSpecial: true },
      { number: 4, kanji: "4階", reading: "よんかい", isSpecial: false },
      { number: 5, kanji: "5階", reading: "ごかい", isSpecial: false },
      { number: 6, kanji: "6階", reading: "ろっかい", isSpecial: true },
      { number: 7, kanji: "7階", reading: "ななかい", isSpecial: false },
      { number: 8, kanji: "8階", reading: "はっかい", isSpecial: true },
      { number: 9, kanji: "9階", reading: "きゅうかい", isSpecial: false },
      { number: 10, kanji: "10階", reading: "じゅっかい", isSpecial: true },
    ],
  },
];
